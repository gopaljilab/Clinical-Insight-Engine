...
import { CheckCircle2, Loader2, TrendingDown } from "lucide-react";
import { useTranslation } from "react-i18next";
import { type AssessmentResponse } from "@shared/routes";
import { useWhatIfAuto } from "@/hooks/use-assessments";

interface PathToImprovementProps {
  assessment: AssessmentResponse;
}

export function PathToImprovement({ assessment }: PathToImprovementProps) {
