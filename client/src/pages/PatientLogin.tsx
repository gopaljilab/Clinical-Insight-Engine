        ...
        {step === "verify" ? (
          <>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                We've sent a 6-digit verification code to <span className="font-semibold text-gray-900 dark:text-gray-100">{verifyEmail}</span>.
              </CardDescription>
            </CardHeader>
            <CardContent className="px-4 sm:px-6">
              <form onSubmit={handleVerifyEmail} className="space-y-5">
                {error && (
                  <div className="rounded-lg border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-950/50 p-3 text-sm text-red-700 dark:text-red-400">{error}</div>
                )}
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="text-center text-2xl tracking-widest font-mono min-h-[48px]"
                    required
                  />
                </div>
                <Button type="submit" className="w-full min-h-[48px]" isLoading={loading} disabled={verificationCode.length !== 6}>
                  Verify & Sign In
                </Button>
